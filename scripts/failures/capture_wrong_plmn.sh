...
default_capture="$repository_root/captures/failures/wrong_plmn/wrong_plmn_raw.pcap"
...
echo "Capturing the wrong-PLMN N2 experiment in the foreground."
echo "Interface: any"
echo "Filter:    SCTP port 38412"
echo "Output:    $capture_file"
echo "Stop the capture with Ctrl+C after the gNB failure is visible."
echo
